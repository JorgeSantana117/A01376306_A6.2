...
class TestHotelManagement(unittest.TestCase):
    ...
    def tearDown(self):
        for f in [self.h_file, self.c_file, self.r_file]:
            if os.path.exists(f):
                os.remove(f)
    ...
    def test_hotel_crud(self):
        ...
        h = self.hm.display_hotel("H1")
        self.assertEqual(h['name'], "Updated Hotel")
    ...
    def test_customer_crud(self):
        ...
        c = self.cm.display_customer("C1")
        self.assertEqual(c['name'], "John Smith")
    ...
    def test_reservation_flow(self):
        ...
        h = self.hm.display_hotel("H1")
        self.assertEqual(h['occupied_rooms'], 0)
